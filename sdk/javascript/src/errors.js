...
export class TACError extends Error {
  constructor(message, code = 'TAC_UNKNOWN_ERROR') {
    super(message);
    this.name = 'TACError';
    this.code = code;
  }
...
export class TACValidationError extends TACError {
  constructor(message, code = 'TAC_VALIDATION_ERROR') {
    super(message, code);
...
export class TACNetworkError extends TACError {
  constructor(message, code = 'TAC_NETWORK_ERROR') {
    super(message, code);
...
export class TACCryptoError extends TACError {
  constructor(message, code = 'TAC_CRYPTO_ERROR') {
    super(message, code);
...
export class TACMessageError extends TACError {
  constructor(message, code = 'TAC_MESSAGE_ERROR') {
    super(message, code);
...
export const TACErrorCodes = {
  ...
  // Security Errors
  KEY_SIZE_TOO_SMALL: 'TAC_KEY_SIZE_TOO_SMALL',
  MESSAGE_TOO_LARGE: 'TAC_MESSAGE_TOO_LARGE'
};
