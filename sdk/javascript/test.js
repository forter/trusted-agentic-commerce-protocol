...
import { JWKSCache, fetchJWKSWithRetry, findEncryptionKey, findSigningKey } from './utils.js';
...
describe('Trusted Agentic Commerce Protocol - JavaScript SDK', () => {
  ...
  describe('TACSender', () => {
    ...
    it('should require domain and privateKey in constructor', async () => {
      ...
      assert.throws(() => new TACSender({ domain: 'test.com' }), /privateKey is required/);
    });
    ...
    it('should generate TAC message with proper structure', async () => {
      ...
      // Mock JWKS fetch
      sender.fetchJWKS = async () => [{ ...recipientJWK, kid: 'merchant.com', use: 'enc', alg: 'RSA-OAEP-256' }];
      ...
      assert.strictEqual(message.version, '2025-08-21');
  ...
  describe('TACRecipient', () => {
    ...
    it('should require domain and privateKey in constructor', async () => {
      ...
      assert.throws(() => new TACRecipient({ domain: 'test.com' }), /privateKey is required/);
    });
    ...
    it('should inspect TAC message without decryption', () => {
      ...
      const base64MockMessage = Buffer.from(mockMessageString).toString('base64');
  ...
  describe('End-to-End Integration', () => {
    ...
    it('should work end-to-end with multiple recipients', async () => {
      ...
      assert.strictEqual(merchantResult.data.user.email.address, 'customer@example.com');
