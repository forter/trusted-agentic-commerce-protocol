...
describe("Utility Functions", () => {
  ...
  describe("getAlgorithmForKey", () => {
    ...
    it("should return correct signing algorithms for EC keys", async () => {
      ...
      assert.strictEqual(getAlgorithmForKey(p256Key as any, "sig"), "ES256");
      assert.strictEqual(getAlgorithmForKey(p384Key as any, "sig"), "ES384");
      assert.strictEqual(getAlgorithmForKey(p521Key as any, "sig"), "ES512");
    });
